/*
  ...
  - A unique constraint covering the columns `[slug]` on the table `SubTopic` will be added. If there are existing duplicate values, this will fail.
...
*/
-- AlterTable
ALTER TABLE "SubTopic" ADD COLUMN     "slug" TEXT NOT NULL;
